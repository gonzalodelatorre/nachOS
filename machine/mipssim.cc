...
Machine::Run()
{
    ...
    interrupt->setStatus(UserMode); //TODO Setea en modo usuario.
    for (;;) {                 //TODO Loop infinito.
        OneInstruction(instr); //TODO Ejecuta instrucción por instrucción.
	interrupt->OneTick();  //TODO machine/interrupt.cc
...
Machine::OneInstruction(Instruction *instr)
{
	...
	if (!machine->WriteMem((tmp & ~0x3), 4, value))
	    return;
	break;
      //TODO RaiseException() está en machine/machine.cc
      //TODO Se reconoce una llamada al sistema
      case OP_SYSCALL: //TODO OP_SYSCALL. /mipssim.h Llamada al sistema.
	//printf("CASE_OPSYSCALL\n");
