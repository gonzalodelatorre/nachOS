...
Machine::RaiseException(ExceptionType which, int badVAddr)
{
    ...
    //TODO Cambia a modo kernel
    interrupt->setStatus(SystemMode);
    ExceptionHandler(which);		// interrupts are enabled at this point TODO ExceptionHandle exception.cc
    //TODO De nuevo vuelve a modo usuario
